...
import ExpUtilsManifs as Utils
...
url = 'http://wcf.tourinsoft.com/Syndication/cdt37/b090fdb5-5dae-428a-bb33-a3b722eab2eb'  # URL
# cheminOutputCC47 = r'tourinsoft.gdb\Manifestation' #Chemin de la table finale
cheminOutputCC47 = r'tourisme@sigora1@vecteur.sde\Manifestation'  # Chemin de la table finale
...
def go():
	Utils.UtilsManif().export(url, tempBddName, addPhoto, tempPicsBddName, cheminOutputCC47, projectionInput, projectionOutput, tempDir, tempPictureDir, proxyURL, entryXPath, elementPropertiesXPath, pictureLabel, objectIDLabel, titleLabel, xLabel, yLabel, projectionMethod, customAttributes)
