...
url = 'http://wcf.tourinsoft.com/Syndication/cdt37/5c5731fb-55f5-4b78-ace7-532d84c0abf6'  # URL
# cheminOutputCC47 = r'tourinsoft.gdb\ActivitesSportives' #Chemin de la table finale
cheminOutputCC47 = r'tourisme@sigora1@vecteur.sde\ActivitesSportives'  # Chemin de la table finale
...
customAttributes = dict() #Type de colonnes personalisees. Rajouter une ligne par colonne personalisee: customAttributes['<clef>'] = '<type>'. Ex: customAttributes['CodePostal'] = 'SHORT'. Les types disponibles sont listes ici: http://help.arcgis.com/fr/arcgisdesktop/10.0/help/index.html#//001700000047000000
